...
* Then edit the newly created scheme to make it use a different env file. From the same "manage scheme" window: Expand the "Build" tab on the left menu
    * Click "Pre-actions", and under the plus sign select "New Run Script Action"
    * Where it says "Type a script or drag a script file", type: `echo ".env.qa" > /tmp/envfile` replacing `.env.qa` with your file.
* Also, you will need to select the executable for the new schema: Expand the "Run" tab on the left menu
